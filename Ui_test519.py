...
"color: rgb(255, 251, 252);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pic_after_label2.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:11pt; font-weight:600; color:#ff0000;\">删除风格化图，转换格式后的图片，和生成无缝贴图过程中expand操作的图片</span></p></body></html>"))
        ...
        self.progress_Info.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:11pt;\">1.对页面初始化，保留工作目录。</span></p><p><span style=\" font-size:11pt;\">2.删除保存过程中生成的lerp_output，temp和seamless_output文件</span></p></body></html>"))
