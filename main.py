...
if __name__=='__main__':
    ...
    class My_gen_style_thread2(QThread):
        ...
        def __init__(self):
            ...
            self.texconv_path = os.getcwd() + "\\result_moss/texconv.exe"
        def set_para(self,txt_path='',work_='',lerg_value=50,chosen_style_pic=''):
        ...
        def save_all(self):
            ...
            style_txt_main2(self.txt_path,self.work_,self.chosen_style_pic)
            for file in f:
                file=file.replace("\n","")
    ...
    class MainWindow(QMainWindow):
        ...
        # def save_not_seamless(self):
        #     base_dir=self.project_base+'/style_transfer/'
        #     project_list=self.multi_dir_project
